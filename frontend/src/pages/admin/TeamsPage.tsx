  ...
  return (
    <div className="space-y-6 p-6 max-w-7xl mx-auto">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        >
          <span className="text-lg leading-none">+</span> Create Team Pod
        </Button>
      </div>
        ...
        <Table>
          <TableHeader className="bg-slate-950/60">
            <TableRow className="border-slate-800 hover:bg-transparent">
              <TableHead className="text-slate-400 font-semibold">Team Name & Description</TableHead>
              <TableHead className="text-slate-400 font-semibold">Team Lead</TableHead>
              <TableHead className="text-slate-400 font-semibold">Assigned Project</TableHead>
              <TableHead className="text-slate-400 font-semibold text-right">Team Members</TableHead>
            </TableRow>
          </TableHeader>
          <TableBody>
            {isLoadingTeams ? (
              ...
              <TableRow>
                <TableCell colSpan={4} className="text-center py-12">
                  <div className="max-w-sm mx-auto space-y-3">
                    ...
                    <h3 className="text-base font-bold text-slate-200">No Sales Pods Found</h3>
              ...
              teams.map((t: any) => (
                <TableRow key={t._id} className="border-slate-800/60 hover:bg-slate-850/50">
                  <TableCell className="font-semibold text-slate-200">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-[11px] text-slate-400">{t.description || 'General Sales Pod'}</p>
                      </div>
                    </div>
                  </TableCell>
